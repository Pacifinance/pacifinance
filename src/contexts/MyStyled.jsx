...
export const MuiCustomDialog = styled(Dialog)`
  && {
    ...
    // border: 4px solid ${({ theme }) => theme.buttonBackgroundColor};
  }
`;
...
export const MuiCustomButton = styled(Button)`
  && {
    ...
    color: ${({ theme }) => theme.textColor};
    hover: ${({ theme }) => theme.BackgroundColor};
  }
`;
...
export const MuiCustomTextField = styled(TextField)`
    && {
        ...
        .MuiInput-underline:after {
          border-bottom-color: ${({ theme }) => theme.buttonBackgroundColor};
        }
        .Mui-focused .MuiInput-underline:after {
          border-bottom-color: blue;
        }
...
export const MyGenericModal = styled.div`
  ...
  background-color: rgba(0, 0, 0, 0.5);
  border-radius: 4px;
  border: 4px solid ${({ theme }) => theme.jollyColor};
`;
...
export const MyButton = styled.button`
  ...
  border: none;
  border-radius: 4px;
  // border-color: ${({ mode }) => mode === 'dark' ? '#fff' : '#000'};
  // border-shadow: 0px 0px 10px 0px rgba(0,0,0,0.75);
  align-items: center;
  font-size: 16px;
  cursor: pointer;
...
export const FeatureIcon = styled.div`
  background-color: ${({ theme }) => theme.iconBackgroundColor};
  color: white;
  padding: 20px;
  border-radius: 50%;
  display: flex;
...
export const Icon = styled.div`
  /* Aggiungi qui l'icona desiderata */
  color: ${({ theme }) => theme.jollyColor};
  text-color: ${({ theme }) => theme.jollyColor};
`;
