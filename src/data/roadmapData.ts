...
const roadmapData: RoadmapItem[] = [
  ...
  },
  {
    ...
    description: {
      it: 'La sezione portafoglio mette in primo piano lo storico gratuito costruito insieme: proponi il prezzo di un titolo o di una crypto per un mese passato e, dopo la verifica di un amministratore, diventa un dato condiviso che completa lo storico di tutti.',
      en: 'The portfolio section highlights free community-built history: submit a stock or crypto price for a past month and, after administrator verification, it becomes shared data that fills history for everyone.'
    },
    status: 'completed',
    category: 'feature',
    icon: '🤲',
  ...
  {
    id: 'investment-balance-reconciliation',
    title: { it: 'Riconciliazione Bilancio e Holding', en: 'Balance and Holdings Reconciliation' },
    description: {
      it: 'Mantieni il totale mensile dichiarato distinto dalla somma delle holding: Pacifinance mostra copertura, valore non dettagliato o dettaglio in eccesso e il peso percentuale di ogni posizione.',
      en: 'Keep the declared monthly total separate from the holdings sum: Pacifinance shows coverage, unallocated or excess detail, and each position\'s percentage weight.'
    },
    status: 'completed',
    category: 'feature',
    icon: '⚖️',
