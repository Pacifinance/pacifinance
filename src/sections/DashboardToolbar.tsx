...
const getSectionNames = (t) => ({
  'balance-overview': t?.dashboard?.totalBalance ? (t?.dashboardLayout?.balanceOverview || 'Balance Overview') : 'Balance Overview',
  'liquidity-investments': t?.dashboardLayout?.liquidityInvestments || 'Liquidity & Investments',
  'income-expense': t?.dashboardLayout?.incomeExpense || 'Income & Outflows',
  'charts': t?.dashboardLayout?.charts || 'Charts',
  'financial-insights': t?.dashboardLayout?.financialInsights || 'Financial Insights',
  'goal-tracker': t?.dashboardLayout?.goalTracker || 'Goals',
  'gamification': t?.dashboardLayout?.gamification || 'Achievements',
});
