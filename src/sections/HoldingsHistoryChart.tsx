...
const TrustLegend = styled.div`
  ...
  i.verified { background: ${(p) => p.theme.successColor}; }
              ...
              type === 'bar' ? (
                ...
                <Line
                  ...
                  dot={(props: { cx?: number; cy?: number; payload?: Record<string, number | string | null> }) => {
                    ...
                    const verified = source === 'provider' || source === 'community';
                    return <circle cx={props.cx} cy={props.cy} r={verified ? 4 : 3.5} fill={verified ? theme.successColor : theme.backgroundColor} stroke={verified ? theme.successColor : '#94a3b8'} strokeWidth={verified ? 1 : 2} />;
                  }}
                  connectNulls={false}
                />
              )
