...
import { PieChart, Pie, Cell, BarChart, Bar, XAxis, YAxis, ResponsiveContainer, Tooltip, RadialBarChart, RadialBar, Legend } from 'recharts';
import { 
    BsBank, 
    BsCashCoin, 
    BsCoin,
...
import { primaryColor, secondaryColor, getColorsBalances } from '../styles/Themes';
...
const ModernDashboard = ({ theme, userData, isHidden, CustomTick }) => {
    ...
    const investments = [
        { 
            ...
            description: 'Azioni individuali'
        },
        { 
            ...
            description: 'Fondi diversificati'
        },
        { 
    ...
    // Dati per i grafici
    const pieData = [
        { name: 'Bilanci Tradizionali', value: totalTraditional, color: '#079164' },
        { name: 'Investimenti', value: totalInvestments, color: '#FF6600' }
    ];
    ...
    return (
        <ModernDashboardContainer theme={theme}>
            <GradientBackground theme={theme} />
            
            <ModernDashboardHeader theme={theme}>
                <ModernDashboardTitle theme={theme}>
                    <MdDashboard style={{ marginRight: '12px', fontSize: '2rem' }} />
                    Dashboard Moderna
                    <HiOutlineSparkles style={{ marginLeft: '12px', color: '#FFD700' }} />
                </ModernDashboardTitle>
                ...
                <ModernBalanceOverview theme={theme}>
                    <div className="balance-main">
                        ...
                        <div className="balance-subtitle">
                            ...
                            Il tuo capitale al {new Date().toLocaleDateString('it-IT')}
                        </div>
                    </div>
                    ...
                    <div className="balance-metrics">
                        <ModernMetricCard theme={theme}>
                            ...
                            <div className="metric-content">
                                ...
                                <div className="metric-label">Liquidità</div>
                        ...
                        <ModernMetricCard theme={theme}>
                            ...
                            <div className="metric-content">
                                ...
                                <div className="metric-label">Investimenti</div>
                                    ...
                                    <FloatingElement delay={index * 0.2}>
                                        ...
                                        <div className="card-content">
                                            ...
                                            <div className="asset-percentage">
                                                {formatPercentage(asset.value, totalBalance)} del totale
                                            </div>
                                        </div>
                                        ...
                                        <div className="card-footer">
                                            <div className="progress-bar">
                                                <div 
                                                    ...
                                                    style={{ 
                                                        width: `${totalBalance > 0 ? (asset.value / totalBalance) * 100 : 0}%`,
                                    ...
                                    <FloatingElement delay={index * 0.15}>
                                        ...
                                        <div className="card-content">
                                            ...
                                            <div className="investment-stats">
                                                <div className="stat">
                                                    <span className="stat-label">Del portafoglio</span>
                                                    <span className="stat-value">{formatPercentage(investment.value, totalInvestments)}</span>
                                                </div>
                                                <div className="stat">
                                                    <span className="stat-label">Del totale</span>
            ...
            <ModernChartsSection theme={theme}>
                ...
                <div style={{ 
                    ...
                    {/* Grafico Overview */}
                    <ModernChartContainer theme={theme}>
                        <h4>Distribuzione Generale</h4>
                    ...
                    <ModernChartContainer theme={theme}>
                        ...
                        <ResponsiveContainer width="100%" height={350}>
                            <PieChart>
                                <Pie
                                    data={detailedPieData.filter(item => item.value > 0)}
                                    cx="50%"
                                    cy="50%"
                                    outerRadius={110}
                                    dataKey="value"
                                    ...
                                    endAngle={450}
                                >
                                    {detailedPieData.filter(item => item.value > 0).map((entry, index) => (
                                        <Cell key={`detailed-${index}`} fill={entry.color} />
                                    ))}
                                </Pie>
                                <Tooltip content={<CustomTooltip />} />
                            </PieChart>
