...
const NewDashboard = ({ theme, userData, isHidden, CustomTick }) => {
    ...
    const incExpData = [
        { 
            ...
            color: colorsIncExp[languages[language].general.incomes]
        },
        { 
            name: languages[language].general.outflows, 
            value: expensesMonth >= 0 ? expensesMonth : 0,
            color: colorsIncExp[languages[language].general.outflows]
        },
        { 
            name: languages[language].general.saved, 
            value: savedMonth >= 0 ? savedMonth : 0,
            color: colorsIncExp[languages[language].general.saved]
        },
    ];
            ...
            <DashboardContent theme={theme}>
                ...
                <ModernChartsSection theme={theme}>
                    ...
                    <div style={{ 
                        ...
                        {/* Grafico Distribuzione Dettagliata */}
