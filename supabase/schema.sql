...
-- Same function, with the optional second balance source (see
-- add-transaction-balance-split.sql) appended as four trailing defaulted
-- arguments — a distinct overload from the one above, same precedent as that
-- one once being a distinct overload of the pre-p_purpose version.
CREATE OR REPLACE FUNCTION "public"."update_transaction_with_shared"("p_user_id" "uuid", "p_transaction_id" bigint, "p_occurred_at" "date", "p_amount" numeric, "p_is_expense" boolean, "p_notes" "text", "p_payment_type_tag_id" bigint, "p_category_tag_id" bigint, "p_user_category_id" bigint, "p_balance_asset_key" "text", "p_balance_detail_type" "text", "p_balance_detail_id" bigint, "p_purpose" "text", "p_shared_mode" "text" DEFAULT 'unchanged'::"text", "p_shared_total" numeric DEFAULT NULL::numeric, "p_shared_own_share" numeric DEFAULT NULL::numeric, "p_balance_asset_key_2" "text" DEFAULT NULL::"text", "p_balance_detail_type_2" "text" DEFAULT NULL::"text", "p_balance_detail_id_2" bigint DEFAULT NULL::bigint, "p_balance_amount_2" numeric DEFAULT NULL::numeric) RETURNS bigint
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."update_transaction_with_shared"("p_user_id" "uuid", "p_transaction_id" bigint, "p_occurred_at" "date", "p_amount" numeric, "p_is_expense" boolean, "p_notes" "text", "p_payment_type_tag_id" bigint, "p_category_tag_id" bigint, "p_user_category_id" bigint, "p_balance_asset_key" "text", "p_balance_detail_type" "text", "p_balance_detail_id" bigint, "p_purpose" "text", "p_shared_mode" "text", "p_shared_total" numeric, "p_shared_own_share" numeric, "p_balance_asset_key_2" "text", "p_balance_detail_type_2" "text", "p_balance_detail_id_2" bigint, "p_balance_amount_2" numeric) OWNER TO "postgres";
...
END) STORED,
    ...
    "balance_asset_key_2" "text",
    "balance_detail_type_2" "text",
    "balance_detail_id_2" bigint,
    "balance_amount_2" numeric,
    ...
    CONSTRAINT "transactions_balance_asset_key_2_check" CHECK (("balance_asset_key_2" = ANY (ARRAY['bank'::"text", 'cash'::"text", 'digitalServices'::"text", 'emergencyFund'::"text", 'stocks'::"text", 'etf'::"text", 'bitcoin'::"text", 'crypto'::"text", 'bonds'::"text", 'funds'::"text", 'commodities'::"text"]))),
    CONSTRAINT "transactions_balance_detail_type_2_check" CHECK (("balance_detail_type_2" = ANY (ARRAY['liquidity'::"text", 'investment'::"text"]))),
    CONSTRAINT "transactions_balance_amount_2_check" CHECK ((("balance_amount_2" IS NULL) OR ("balance_amount_2" > (0)::numeric))),
...
CREATE TABLE IF NOT EXISTS "public"."user_liquidity_accounts" (
    ...
    CONSTRAINT "user_liquidity_accounts_unit_value_check" CHECK ((("unit_value" IS NULL) OR ("unit_value" > (0)::numeric)))
);
...
ALTER TABLE ONLY "public"."user_liquidity_accounts"
    ADD CONSTRAINT "user_liquidity_accounts_fallback_account_id_fkey" FOREIGN KEY ("fallback_account_id") REFERENCES "public"."user_liquidity_accounts"("id") ON DELETE SET NULL;
...
GRANT ALL ON FUNCTION "public"."update_transaction_with_shared"("p_user_id" "uuid", "p_transaction_id" bigint, "p_occurred_at" "date", "p_amount" numeric, "p_is_expense" boolean, "p_notes" "text", "p_payment_type_tag_id" bigint, "p_category_tag_id" bigint, "p_user_category_id" bigint, "p_balance_asset_key" "text", "p_balance_detail_type" "text", "p_balance_detail_id" bigint, "p_purpose" "text", "p_shared_mode" "text", "p_shared_total" numeric, "p_shared_own_share" numeric, "p_balance_asset_key_2" "text", "p_balance_detail_type_2" "text", "p_balance_detail_id_2" bigint, "p_balance_amount_2" numeric) TO "anon";
GRANT ALL ON FUNCTION "public"."update_transaction_with_shared"("p_user_id" "uuid", "p_transaction_id" bigint, "p_occurred_at" "date", "p_amount" numeric, "p_is_expense" boolean, "p_notes" "text", "p_payment_type_tag_id" bigint, "p_category_tag_id" bigint, "p_user_category_id" bigint, "p_balance_asset_key" "text", "p_balance_detail_type" "text", "p_balance_detail_id" bigint, "p_purpose" "text", "p_shared_mode" "text", "p_shared_total" numeric, "p_shared_own_share" numeric, "p_balance_asset_key_2" "text", "p_balance_detail_type_2" "text", "p_balance_detail_id_2" bigint, "p_balance_amount_2" numeric) TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_transaction_with_shared"("p_user_id" "uuid", "p_transaction_id" bigint, "p_occurred_at" "date", "p_amount" numeric, "p_is_expense" boolean, "p_notes" "text", "p_payment_type_tag_id" bigint, "p_category_tag_id" bigint, "p_user_category_id" bigint, "p_balance_asset_key" "text", "p_balance_detail_type" "text", "p_balance_detail_id" bigint, "p_purpose" "text", "p_shared_mode" "text", "p_shared_total" numeric, "p_shared_own_share" numeric, "p_balance_asset_key_2" "text", "p_balance_detail_type_2" "text", "p_balance_detail_id_2" bigint, "p_balance_amount_2" numeric) TO "service_role";
